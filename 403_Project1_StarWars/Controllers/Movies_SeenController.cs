...
namespace _403_Project1_StarWars.Controllers
{
    public class Movies_SeenController : Controller
    {
        ...
        {
            myMovies.MovieID = lstMovies.Count() + 1; //the autogenerated movie ID / I think this should go inside hte loop
            if (ModelState.IsValid)
               
            {
                //myMovies.MovieID = lstMovies.Count() + 1; Right here
        ...
        [HttpPost]
        public ActionResult EditMovie(SeenMovies myModel) //THIS CURRENTLY DOESN'T SAVE EDITS CUZ HAS PERMANENT MOVIEID OF 0??
        {
